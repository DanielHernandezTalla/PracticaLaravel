                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action={{ route('usuarios.update', ['id' => $usuario->id]) }} method="POST">
                        ...
                        <a href="{{ route('usuarios.index') }}"
                            class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:ring-gray-100">Cancelar</a>
                        <button type="submit"
                            class="text-white bg-blue-700 hover:bg-blue-800font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Guardar</button>
                    </form>
